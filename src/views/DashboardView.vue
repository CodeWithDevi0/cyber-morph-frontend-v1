  ...
  <div class="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700 text-pixel-plum">
    ...
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-4">
      <div>
        <h1
          v-if="auth.isPlayer"
          class="text-4xl font-black font-display tracking-tight text-pixel-plum uppercase"
        >
          Dashboard
        </h1>
        <h1
          v-else-if="auth.isEducator"
          class="text-4xl font-black font-display tracking-tight text-pixel-plum uppercase"
        >
          Educator Portal
        </h1>
    ...
    <div v-else-if="auth.isEducator" class="pixel-card border-pixel-moss/30 py-20 text-center">
      <div
        class="w-20 h-20 bg-pixel-moss/10 rounded-2xl flex items-center justify-center mx-auto mb-8 shadow-pixel-purple border border-pixel-moss/20"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="32"
      ...
      <h2 class="text-3xl font-black text-pixel-plum font-display mb-3 uppercase tracking-tight">
        Classroom Management
      </h2>
      <p class="text-pixel-plum/60 max-w-md mx-auto mb-10 font-bold text-sm leading-relaxed">
    ...
    <div v-else-if="auth.isAdmin" class="pixel-card border-byte-coral/30 py-20 text-center">
      <div
        class="w-20 h-20 bg-byte-coral/10 rounded-2xl flex items-center justify-center mx-auto mb-8 shadow-pixel-purple border border-byte-coral/20"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="32"
