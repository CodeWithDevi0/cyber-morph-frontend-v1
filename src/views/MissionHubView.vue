    ...
    <div class="grid grid-cols-1 lg:grid-cols-[1fr_350px] gap-8">
      ...
      <div class="space-y-6">
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          >
            ...
            <div class="aspect-video bg-pixel-lavender/20 relative overflow-hidden">
              ...
              <!-- Map Index Badge -->
              <div
                class="absolute top-3 left-3 px-2 py-1 bg-white/90 backdrop-blur-sm rounded text-[10px] font-black text-pixel-plum shadow-sm"
              >
                TARGET {{ map.id + 1 }}
              </div>
            </div>
            ...
            <div class="p-4 bg-white/50 backdrop-blur-sm">
              <div class="flex justify-between items-center mb-1">
                ...
                <span
                  v-if="isMapUnlocked(map.id)"
                  class="text-[9px] font-black px-2 py-0.5 rounded-full bg-pixel-moss/10 text-pixel-moss border border-pixel-moss/20"
                  >READY</span
                >
              </div>
        ...
        <div class="pixel-card bg-pixel-violet/5 border-pixel-violet/10">
          <h4 class="text-xs font-black uppercase tracking-widest text-pixel-violet mb-4">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="flex gap-4">
              ...
              <div>
                ...
                <p class="text-[11px] text-pixel-plum/60 leading-relaxed font-bold">
                  Encrypted connection required. Session data is synced to cloud upon extraction.
                </p>
              </div>
            </div>
            <div class="flex gap-4">
              ...
              <div>
                <p class="text-[11px] font-black text-pixel-plum uppercase mb-1">
                  Real-time Feedback
                </p>
                <p class="text-[11px] text-pixel-plum/60 leading-relaxed font-bold">
                  Attacker AI adapts to your defensive choices in real-time. Stay alert.
                </p>
              </div>
            </div>
          </div>
      ...
      <div class="space-y-6">
        <div class="pixel-card sticky top-24 overflow-hidden p-0">
          <div
            class="aspect-video bg-pixel-plum/5 relative overflow-hidden border-b border-pixel-plum/10"
          >
            <img
          ...
          <div class="p-6 space-y-6">
            <div>
              <div class="flex items-center gap-2 mb-2">
                <span
                  class="text-[10px] font-black px-2 py-0.5 bg-pixel-violet/10 text-pixel-violet rounded uppercase tracking-widest"
                  >{{ selectedMap.difficulty }}</span
                >
                <span
                  class="text-[10px] font-black px-2 py-0.5 bg-pixel-plum/5 text-pixel-plum/40 rounded uppercase tracking-widest"
                  >ID: 00{{ selectedMapId + 1 }}</span
                >
              </div>
              ...
              <div class="flex justify-between text-xs font-bold">
                ...
                <div class="flex gap-1">
                  <div
                    ...
                    :class="i <= selectedMapId + 1 ? 'bg-byte-coral' : 'bg-pixel-plum/10'"
                  ></div>
                </div>
              </div>
            </div>
