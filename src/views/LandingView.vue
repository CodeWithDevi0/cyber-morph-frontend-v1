...
const showcases = [
  {
    ...
    eyebrow: 'First Map',
    description:
      'Defend your personal space. Master password hygiene, router security, and IoT protection.',
    image: getMap('home'),
  },
  {
    title: 'Internet Cafe',
    eyebrow: 'Second Map',
    description:
      'Stay safe on the go. Learn the dangers of public Wi-Fi, shared terminals, and protecting data.',
  ...
  },
  {
    ...
    eyebrow: 'Third Map',
    description:
      'Identify phishing attempts, secure your workstation, and follow data privacy protocols.',
    image: getMap('office'),
  },
  {
    title: 'Public Park',
    eyebrow: 'Fourth Map',
    description:
      'Master physical awareness, secure charging habits, and device privacy in public spaces.',
...
<template>
  <main
    class="landing-page min-h-screen bg-pixel-lilac text-pixel-plum selection:bg-pixel-violet selection:text-white"
  >
