      ...
      <div class="space-y-6">
        <div class="pixel-card sticky top-24 overflow-hidden p-0">
          ...
          <div class="p-6 space-y-6">
            ...
            <div v-if="launchError" class="p-3 bg-byte-coral/10 border border-byte-coral/20 rounded text-[10px] font-black text-byte-coral uppercase animate-bounce">{{ launchError }}</div>
