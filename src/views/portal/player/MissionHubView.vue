        ...
        <div class="pixel-card bg-pixel-violet/5 border-pixel-violet/10">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="flex gap-4">
              ...
              <div>
                <p class="text-11 font-black text-pixel-plum uppercase mb-1">Live Simulation</p>
                <p class="text-11 text-pixel-plum/60 leading-relaxed font-bold">Encrypted connection required. Session data is synced to cloud upon extraction.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="space-y-6">
        <div class="pixel-card sticky top-24 overflow-hidden p-0">
          <div class="aspect-video bg-pixel-plum/5 relative overflow-hidden border-b border-pixel-plum/10">
            <img v-if="getMap(selectedMap.slug)" :src="getMap(selectedMap.slug)" :alt="selectedMap.name" class="w-full h-full object-cover" style="image-rendering: pixelated" />
