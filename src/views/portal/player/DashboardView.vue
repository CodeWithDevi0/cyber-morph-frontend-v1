<template>
  <div class="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700 text-pixel-plum">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      >
        <p class="text-pixel-10 uppercase font-black text-pixel-violet/70 mb-2 tracking-widest">
          Current Target
        </p>
        ...
        <button
          class="mt-4 text-pixel-10 font-black uppercase tracking-widest text-pixel-violet hover:brightness-75 transition-all"
        >
          Mission Details
        </button>
      </div>
    ...
    <div class="pixel-card">
      <div class="flex items-center justify-between mb-8 pb-4 border-b border-pixel-plum/10">
        ...
        <router-link
          to="/portal/history"
          class="text-pixel-10 font-black text-pixel-violet hover:underline tracking-[0.15em] uppercase"
        ...
        <table class="w-full text-left">
          ...
          <tbody class="divide-y divide-pixel-plum/5">
            ...
            >
              ...
              <td class="py-5 px-2">
                <span
                  class="text-pixel-9 px-2.5 py-1 border-2 rounded font-black tracking-widest uppercase"
                  :class="
                    session.result === 'win'
              ...
              <td class="py-5 px-2 text-right">
                <div class="flex flex-col items-end">
                  ...
                  >
                  <span class="text-pixel-9 text-byte-coral/80 font-bold font-mono"
                    >-{{ session.credits_lost }}</span
                  >
                </div>
              </td>
              <td
                class="py-5 px-2 text-right text-pixel-10 text-pixel-plum/50 font-black font-mono"
              >
