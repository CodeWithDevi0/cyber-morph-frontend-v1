...
<template>
  <aside
    class="w-64 bg-white/80 backdrop-blur-xl border-r border-pixel-violet/15 h-screen flex flex-col shadow-pixel-purple overflow-hidden"
  >
    <!-- Brand / Logo -->
        ...
        :to="
          auth.isAdmin
            ...
            : auth.isEducator
              ...
              : '/portal/dashboard'
        "
        class="text-xl font-black tracking-tighter text-pixel-plum group"
      >
        CYBER<span class="text-pixel-violet group-hover:text-pixel-plum transition-colors"
          >MORPH</span
        >
      </router-link>
      <p class="text-[9px] font-black text-pixel-violet uppercase tracking-[0.3em] mt-1 opacity-60">
        Operations v1.0
      </p>
    </div>
    ...
    <nav class="flex-1 overflow-y-auto p-4 space-y-2 no-scrollbar">
      ...
      >
        ...
        <div
          ...
          class="absolute left-0 top-0 w-1 h-full bg-white/40"
        ></div>
    ...
    <div class="p-4 border-t border-pixel-plum/5 bg-pixel-plum/5">
      <div class="flex items-center gap-3 mb-4 px-2">
        <div
          class="w-10 h-10 rounded bg-pixel-violet/10 flex items-center justify-center border border-pixel-violet/20"
        >
        ...
        <div class="overflow-hidden">
          ...
          <p class="text-[9px] font-black text-pixel-violet uppercase tracking-tighter truncate">
